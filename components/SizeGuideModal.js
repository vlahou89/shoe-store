...
function SizeGuideModal() {
  ...
  return (
    <div>
      <div class="fixed inset-0 bg-gray-500 bg-opacity-80  transition-opacity  z-100"></div>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="fixed inset-0 w-full h-44 ">
            <div className="flex items-center min-h-screen px-4 py-8 m-10">
              <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg h-full m-auto">
                <div className="mt-3">
