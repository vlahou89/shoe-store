...
"
    >
      <div className="flex flex-col justify-center items-center backdrop-brightness-50 w-screen h-screen lg:mt-32">
        ...
        <Link href="/Shop">
          <a className="mt-20 md:mt-32 px-6 rounded-xl py-4 bg-gold hover:from-amber-600 hover:to-red-700 text-xl md:text-2xl text-white font-semibold drop-shadow-lg ">
            OUR PRODUCTS
          </a>
        </Link>
      </div>
